...
// ══════════════════════════════════════════════════════════
// BASE CARDS - Fully Verified (Fake SV cards removed, Promos added!)
// ══════════════════════════════════════════════════════════
const BASE_CARDS: Card[] = [
  ...
  { id: 'tk2-4', name: 'Gardevoir', set: 'EX Trainer Kit: Latias', setCode: 'tk2', number: '4/10', cardNum: '004', setTotal: '10', language: 'EN', rarity: 'Rare Holo', price: 10, type: 'Psychic', era: 'EX', artworkGroup: 'tk2-4', releaseYear: 2004, notes: 'Latias Half Deck' },
  ...
  { id: 'chp-16', name: 'Gardevoir V', set: "Champion's Path", setCode: 'swsh35', number: '16/73', cardNum: '016', setTotal: '73', language: 'EN', rarity: 'Rare Holo V', price: 8, type: 'Psychic', era: 'SWSH', artworkGroup: 'chp-16', releaseYear: 2020, locales: { JP: { set: 'Explosive Walker', setCode: 'S2a', number: '030/070', cardNum: '030', setTotal: '070' }, DE: { set: 'Weg des Champs' } } },
  { id: 'chp-17', name: 'Gardevoir VMAX', set: "Champion's Path", setCode: 'swsh35', number: '17/73', cardNum: '017', setTotal: '73', language: 'EN', rarity: 'Rare Holo VMAX', price: 12, type: 'Psychic', era: 'SWSH', artworkGroup: 'chp-17', releaseYear: 2020, locales: { JP: { set: 'Explosive Walker', setCode: 'S2a', number: '031/070', cardNum: '031', setTotal: '070' } } },
  { id: 'chp-70', name: 'Gardevoir V', set: "Champion's Path", setCode: 'swsh35', number: '70/73', cardNum: '070', setTotal: '73', language: 'EN', rarity: 'Rare Ultra', price: 22, type: 'Psychic', era: 'SWSH', artworkGroup: 'chp-70', isSecret: true, releaseYear: 2020, notes: 'Full Art', locales: { JP: { set: 'Explosive Walker', setCode: 'S2a', number: '074/070', cardNum: '074', setTotal: '070' } } },
  { id: 'chp-76', name: 'Gardevoir VMAX', set: "Champion's Path", setCode: 'swsh35', number: '76/73', cardNum: '076', setTotal: '73', language: 'EN', rarity: 'Rare Rainbow', price: 15, type: 'Psychic', era: 'SWSH', artworkGroup: 'chp-76', isSecret: true, releaseYear: 2020, notes: 'Rainbow Rare', locales: { JP: { set: 'Explosive Walker', setCode: 'S2a', number: '081/070', cardNum: '081', setTotal: '070' } } },
  ...
  { id: 'me02pt5-089', name: 'Mega Gardevoir ex', set: 'Mega Evolution Promos', setCode: 'me02pt5', number: '089', cardNum: '089', setTotal: '132', language: 'EN', rarity: 'Promo', price: 12, type: 'Psychic', era: 'SV', artworkGroup: 'me02pt5-089', releaseYear: 2025 },
